...
class _LaunchTargetFormState extends State<LaunchTargetForm> {
  ...
  final _serviceController = TextEditingController(text: 'https://xmit.co');
              ...
              children: [
                  ...
                  child: TextFormField(
                    ...
                    validator: (value) {
                      ...
                      if (!value.startsWith('http://') && !value.startsWith('https://')) {
                        return 'Hosting providers must start with http:// or https://';
                      }
                      return null;
                    },
                  ),
                ...
                IconButton(
                  ...
                  onPressed: _serviceController.text.isNotEmpty
                      ? () async {
                          final uri = Uri.tryParse(_serviceController.text);
                          if (uri != null) {
                            try {

...
class HomeScreen extends StatelessWidget {
  ...
  Future<void> _handleImportProject(BuildContext context) async {
    ...
    if (result.isSuccess) {
      provider.addProject(result.data!);
    ...
    return Scaffold(
      body: Selector<ProjectProvider, bool>(
        ...
        builder: (context, isLoadingProjects, _) {
          ...
          return LayoutBuilder(
            ...
            children: [
              ...
              Selector<ProjectProvider,
                  (List<Project>, Task?, Site?, bool, Project?, Project?, bool, Set<String>)>(
                selector: (_, provider) => (
                  provider.projects,
                ...
                builder: (context, data, _) {
                  final (projects, selectedTask, selectedLaunch, showingForm, configuringProject, creatingLaunchFor, showingSettings, projectsBeingImported) = data;
          ...
          Expanded(
            child: Selector<ProjectProvider, (Task?, Site?, bool, Project?, Project?, bool, String?)>(
              selector: (_, provider) => (
                provider.selectedTask,
                provider.selectedLaunch,
                provider.showingCreationForm,
              ...
              builder: (context, data, _) {
                final (selectedTask, selectedLaunch, showingForm, configuringProject, creatingLaunchFor, showingSettings, settingsBannerMessage) = data;
